...
public class ArrayBlockingQueue<E> extends AbstractQueue<E> implements BlockingQueue<E>, java.io.Serializable{
    ...
    class Itrs {
         ...
         */
        private class Node extends WeakReference<ArrayBlockingQueue.Itr> {
            Node next;

            Node(ArrayBlockingQueue.Itr iterator, Node next) {
                super(iterator);
                this.next = next;
            }
        }
        ...
        Itrs(ArrayBlockingQueue.Itr initial) {
            register(initial);
        }
        ...
        Itr() {
            ...
            try {
                if (count == 0) {
                    ...
                    if (itrs == null) {
                        itrs = new ArrayBlockingQueue.Itrs(this);
                    } else {
