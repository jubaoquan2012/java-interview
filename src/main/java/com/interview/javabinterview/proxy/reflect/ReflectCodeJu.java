package com.interview.javabinterview.proxy.reflect;
...
public class ReflectCodeJu {
    ...
    private static void method_1() throws ClassNotFoundException, IllegalAccessException, InstantiationException, NoSuchMethodException, InvocationTargetException {
        ...
        Class<?> clazz_3 = Class.forName("com.interview.javabinterview.proxy.reflect.target.Book");
    ...
    private static void method_6() {
        try {
            Class<?> carClazz = Class.forName("com.interview.javabinterview.proxy.reflect.target.Car");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private static Class<?> getBookClass() {
        Class<?> clazz = null;
        try {
            clazz = Class.forName("com.interview.javabinterview.proxy.reflect.target.Book");
