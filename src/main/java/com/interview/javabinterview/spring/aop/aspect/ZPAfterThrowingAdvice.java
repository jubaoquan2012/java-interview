 ...
 */
public class ZPAfterThrowingAdvice extends ZPAbstractAspectAdvice implements ZPMethodInterceptor {

    public ZPAfterThrowingAdvice(Method aspectMethod, Object aspectTarget) {
