package com.interview.javabinterview.spring.aop.config;
...
public class ZPAopConfig {
    ...
    private String aspectAfterTrowingName;
    ...
    public String getAspectAfterTrowingName() {
        return aspectAfterTrowingName;
    }

    public void setAspectAfterTrowingName(String aspectAfterTrowingName) {
        this.aspectAfterTrowingName = aspectAfterTrowingName;
    }
}
